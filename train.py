...
from tf2marl.multiagent.SG_environment import MultiAgentEnv
...
def train_config():
    ...
    update_rate = 50  # update policy after each x steps
    ...
    use_target_action = (
        True  # use target action in environment, instead of normal action
    )
...
def train(
    ...
    # env.n_adversaries = min(env.n, arglist.num_adversaries)
    env.n_adversaries = env.n
    ...
    while True:
        ...
        #            print("H" * 20, logger.agent_rewards)
